...
void
set_key_values(KeyValue* const new_key_values, const unsigned int new_number_of_key_values) {
...
static int
key_value_compare_keys(const void* a, const void* b) {
