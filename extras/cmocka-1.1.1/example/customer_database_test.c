...
extern DatabaseConnection*
connect_to_customer_database(void);
extern unsigned int
get_customer_id_by_name(DatabaseConnection* const connection, const char* const customer_name);

/* Mock query database function. */
static unsigned int
mock_query_database(DatabaseConnection* const connection, const char* const query_string, void*** const results) {
...
DatabaseConnection*
connect_to_database(const char* const database_url, const unsigned int port) {
...
static void
test_connect_to_customer_database(void** state) {
	(void)state; /* unused */
...
static void
test_get_customer_id_by_name(void** state) {
	...
	will_return(mock_query_database, cast_ptr_to_largest_integral_type(&customer_ids));
