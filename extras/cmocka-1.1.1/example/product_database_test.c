...
connect_to_product_database(void);
...
static void
test_connect_to_product_database(void** state) {
	(void)state; /* unused */
...
static void
test_connect_to_product_database_bad_url(void** state) {
	(void)state; /* unused */
 ...
 * test function. */
static void
test_connect_to_product_database_missing_parameter(void** state) {
	(void)state; /* unused */
