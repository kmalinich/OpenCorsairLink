...
static void
test_find_item_by_value(void** state) {
	unsigned int i;
...
static void
test_sort_items_by_key(void** state) {
	unsigned int i;
...
main(void) {
	const struct CMUnitTest tests[] = {
		cmocka_unit_test_setup_teardown(test_find_item_by_value, create_key_values, destroy_key_values),
		cmocka_unit_test_setup_teardown(test_sort_items_by_key, create_key_values, destroy_key_values),
	};
